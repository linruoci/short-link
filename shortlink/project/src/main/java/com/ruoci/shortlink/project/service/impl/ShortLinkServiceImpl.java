...
import com.ruoci.shortlink.project.config.GotoDomainWhiteListConfiguration;
...
import com.ruoci.shortlink.project.dto.resp.*;
import com.ruoci.shortlink.project.mq.producer.DelayShortLinkStatsProducer;
import com.ruoci.shortlink.project.service.LinkStatsTodayService;
...
import static com.ruoci.shortlink.project.common.constant.RedisKeyConstant.*;
import static com.ruoci.shortlink.project.common.constant.ShortLinkConstant.AMAP_REMOTE_URL;
...
//            双重判定锁.
    ...
    public void shortLinkStats(String fullShortUrl, String gid, ShortLinkStatsRecordDTO statsRecord) {
        ...
        try{
            ...
            baseMapper.increment(gid, fullShortUrl, 1, statsRecord.getUvFirstFlag() ? 1 : 0, statsRecord.getUipFirstFlag() ? 1 : 0);
